...
Here's how to do this for a proportion assuming 

  * the proprtion remains constant
  * the data values are each independent of the others.
...
## Is the majority of the world covered by water?
...
Our usual approach is to do **posterior sampling**.  This is because
  ...
  * it is very easy and accurate (it works better if we do a larger posterior sample)
  
```{r, fig.keep = "last"}
posterior_sample <-
  with(BinomGrid, sample(p, size = 1e5, prob = posterior, replace = TRUE))
...
Using the data you collected and the data from several neighboring groups, 

  * Create an appropriate grid
  * Plot the posterior 
  * Compute the posterior probabity that the majority of the earth is covered with water
  * Compute a central 95% credible interval for the proprtion of the earth covered with water.
  
Do this for a uniform prior and for at least one other prior.
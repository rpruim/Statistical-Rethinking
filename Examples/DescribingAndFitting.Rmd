...
The posterior distribution for $\sigma$ is not normal.  (This was especially clear 
when we looked a small sample using the grid method.)

The posterior for $\log(\sigma)$ is better approximated by a normal distribution.
We can fit that model by adding in a transformation of the parameter.

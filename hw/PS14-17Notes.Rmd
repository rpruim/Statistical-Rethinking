...
## PS 14
  ...
  1. **Avoid ambiguity:**  When you use words like "mean" be sure to say what the mean if
  *of*.  We have lots of means in these problems -- mean of the response
  variable, mean of each predictor variable, means of the priors, mean of the
  posteriors.  
  ...
  be more pronounced when there is less data.
